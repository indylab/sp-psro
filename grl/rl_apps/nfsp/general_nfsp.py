...
import grl
from grl.algos.nfsp_rllib.nfsp import get_store_to_avg_policy_buffer_fn, get_avg_policy_buffer_stats_fn
...
def train_off_policy_rl_nfsp(results_dir: str,
    ...
    get_avg_policy_buffer_stats = get_avg_policy_buffer_stats_fn(nfsp_trainer=avg_trainer)
        ...
        def on_postprocess_trajectory(self, *, worker: "RolloutWorker", episode: MultiAgentEpisode, agent_id: AgentID,
            ...
            for average_policy_id, br_policy_id in [("average_policy_0", "best_response_0"),
                ...
                if policy_id == average_policy_id:
                    ...
                    if "action_probs" in postprocessed_batch:
                        del postprocessed_batch.data["action_probs"]
                    if "exploit_actions" in postprocessed_batch:
                        del postprocessed_batch.data["exploit_actions"]
    ...
    while True:
        ...
        if print_train_results:
            ...
            reservoir_buffer_stats = get_avg_policy_buffer_stats()
            log(pretty_dict_str(reservoir_buffer_stats))
