...
scenario_catalog.add(PSROScenario(
    name="kuhn_rn_psro_dqn",
    ray_cluster_cpus=default_if_creating_ray_head(default=60),
    ray_cluster_gpus=default_if_creating_ray_head(default=0),
    ray_object_store_memory_cap_gigabytes=1,
    env_class=PokerMultiAgentEnv,
    env_config={
...
leduc_psro_dqn_regret = leduc_psro_dqn.with_updates(
    name="leduc_psro_dqn_regret",
    # same as normal leduc psro dqn but with a static stopping condition
    psro_get_stopping_condition=lambda: EpisodesSingleBRRewardPlateauStoppingCondition(
        br_policy_id="best_response",
        dont_check_plateau_before_n_episodes=int(1e5),
        check_plateau_every_n_episodes=-1,
        minimum_reward_improvement_otherwise_plateaued=-1,
        max_train_episodes=int(1e5),
    ),
)
scenario_catalog.add(leduc_psro_dqn_regret)

scenario_catalog.add(leduc_psro_dqn_regret.with_updates(
    name="leduc_psro_dqn_regret_no_payoff_calc",
    num_eval_workers=1,
    games_per_payoff_eval=1,
))

scenario_catalog.add(leduc_psro_dqn_regret.with_updates(
    name="leduc_rn_psro_dqn_regret",
    ray_cluster_cpus=default_if_creating_ray_head(default=30),
))

leduc_psro_ppo_discrete_action = leduc_psro_dqn.with_updates(
    name="leduc_psro_ppo_discrete_action",
    ...
    get_trainer_config=psro_leduc_ppo_discrete_action_params,
    allow_stochastic_best_responses=True,
)
scenario_catalog.add(leduc_psro_ppo_discrete_action)


leduc_psro_ppo_discrete_action_regret = leduc_psro_ppo_discrete_action.with_updates(
    name="leduc_psro_ppo_discrete_action_regret",
    psro_get_stopping_condition=lambda: EpisodesSingleBRRewardPlateauStoppingCondition(
        br_policy_id="best_response",
        dont_check_plateau_before_n_episodes=int(1e5),
        check_plateau_every_n_episodes=-1,
...
scenario_catalog.add(leduc_psro_ppo_discrete_action_regret)

leduc_rn_psro_ppo_discrete_action_regret = leduc_psro_ppo_discrete_action_regret.with_updates(
    name="leduc_rn_psro_ppo_discrete_action_regret",
    ray_cluster_cpus=default_if_creating_ray_head(default=30),
)
scenario_catalog.add(leduc_rn_psro_ppo_discrete_action_regret)


leduc_symmetric_rn_psro_ppo_discrete_action_regret = leduc_rn_psro_ppo_discrete_action_regret.with_updates(
    name="leduc_symmetric_rn_psro_ppo_discrete_action_regret",
    env_config={
        'version': "leduc_poker",
        "fixed_players": False,
        "append_valid_actions_mask_to_obs": True,
...
scenario_catalog.add(leduc_symmetric_rn_psro_ppo_discrete_action_regret)



scenario_catalog.add(leduc_psro_dqn_regret.with_updates(
    name="leduc_psro_dqn_regret_gpu",
    ray_cluster_gpus=default_if_creating_ray_head(default=1),
))


leduc_psro_dqn_regret_constant_epsilon = leduc_psro_dqn_regret.with_updates(
    name="leduc_psro_dqn_regret_constant_epsilon",
    get_trainer_config=psro_leduc_dqn_params_constant_epsilon_0p2,
)
scenario_catalog.add(leduc_psro_dqn_regret_constant_epsilon)


leduc_psro_dqn_regret_avg_pol = leduc_psro_dqn_regret.with_updates(
    name="leduc_psro_dqn_regret_avg_pol",
    ray_cluster_gpus=default_if_creating_ray_head(default=1),
    policy_classes={
        "metanash": SimpleQTorchPolicyPatched,
        "best_response": SimpleQTorchPolicyPatched,
...
scenario_catalog.add(leduc_psro_dqn_regret_avg_pol)

leduc_psro_dqn_regret_avg_pol_sanity_check = leduc_psro_dqn_regret.with_updates(
    name="leduc_psro_dqn_regret_avg_pol_sanity_check",
    ray_cluster_gpus=default_if_creating_ray_head(default=1),
    policy_classes={
        "metanash": SimpleQTorchPolicyPatched,
        "best_response": SimpleQTorchPolicyPatched,
        "eval": MixedClassEvalPolicyDQNDebug,
    },
)
scenario_catalog.add(leduc_psro_dqn_regret_avg_pol_sanity_check)

leduc_psro_dqn_regret_avg_pol_sanity_check_same_instance = leduc_psro_dqn_regret.with_updates(
    name="leduc_psro_dqn_regret_avg_pol_sanity_check_same_instance",
    ray_cluster_gpus=default_if_creating_ray_head(default=1),
    policy_classes={
        "metanash": SimpleQTorchPolicyPatched,
        "best_response": SimpleQTorchPolicyPatched,
        "eval": MixedClassEvalPolicyDQNDebugSameInstance,
    },
)
scenario_catalog.add(leduc_psro_dqn_regret_avg_pol_sanity_check_same_instance)


leduc_psro_dqn_regret_avg_pol_constant_epsilon = leduc_psro_dqn_regret_avg_pol.with_updates(
    name="leduc_psro_dqn_regret_avg_pol_constant_epsilon",
    get_trainer_config=psro_leduc_dqn_params_constant_epsilon_0p2,
)
scenario_catalog.add(leduc_psro_dqn_regret_avg_pol_constant_epsilon)


scenario_catalog.add(leduc_psro_dqn_regret.with_updates(
    name="leduc_psro_dqn_regret_longer_training",
    # same as normal leduc psro dqn but with a static stopping condition
    psro_get_stopping_condition=lambda: EpisodesSingleBRRewardPlateauStoppingCondition(
        br_policy_id="best_response",
        dont_check_plateau_before_n_episodes=int(1e5 * 2),
        check_plateau_every_n_episodes=-1,
        minimum_reward_improvement_otherwise_plateaued=-1,
        max_train_episodes=int(1e5 * 2),
    ),
))

scenario_catalog.add(leduc_psro_dqn_regret.with_updates(
    name="leduc_psro_dqn_regret_longer_training_double_explore",
    # same as normal leduc psro dqn but with a static stopping condition
    psro_get_stopping_condition=lambda: EpisodesSingleBRRewardPlateauStoppingCondition(
        br_policy_id="best_response",
        dont_check_plateau_before_n_episodes=int(1e5 * 2),
    ...
    get_trainer_config=psro_leduc_dqn_params_longer_2x_explore_anneal,

))

scenario_catalog.add(leduc_psro_dqn.with_updates(
    name="10_card_leduc_psro_dqn",
    env_config={
        "version": "leduc_poker_10_card",
        "fixed_players": True,
        "append_valid_actions_mask_to_obs": True,
    },
))
...
scenario_catalog.add(leduc_psro_dqn.with_updates(
    name="symmetric_leduc_rn_psro_dqn",
    ray_cluster_cpus=default_if_creating_ray_head(default=30),
    env_config={
        'version': "leduc_poker",
        "fixed_players": False,
