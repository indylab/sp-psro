...
class StochasticSamplingValidActionsEpsilonGreedy(Exploration):
    ...
    def get_exploration_action(self,
        ...
        return self._get_torch_exploration_action(action_distribution, q_values, explore,
                                                  timestep)
    ...
    def _get_torch_exploration_action(self, action_distribution: ActionDistribution,
        ...
        self.exploit_action = exploit_action
        ...
        if explore:
            ...
            return action, action_distribution.logp(action)
